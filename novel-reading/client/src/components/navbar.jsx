        ...
        <>
            <nav className={`navbar ${visible ? 'transform translate-y-0' : 'transform -translate-y-full'}`}>
                ...
                >
                    ...
                    />
                    <button type="submit" className="absolute right-4 top-1/2 transform -translate-y-1/2 text-xl text-dark-grey">
                ...
                <ul className="menu flex gap-5">
                    <li>
                        ...
                        {listOpen && (
                            <div ref={listRef} className="absolute border border-smoke rounded-lg bg-white">
