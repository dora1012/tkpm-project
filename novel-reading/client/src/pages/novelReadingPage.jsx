...
const novelReadingPage = () => {
  ...
  return (
    <div className="container mx-auto p-8 w-9/12 shadow" style={{ backgroundColor: background, fontSize: `${fontSize}px` }}>
      ...
      <SettingPanel setBackground={setBackground} setFontSize={setFontSize} />
    </div>
  );
};
